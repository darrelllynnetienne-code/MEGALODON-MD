...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "MEGALODON~MD~OxgwXYpQ#03u0ULepQzpuYwAan76OGOhGYaZpPY3xkkJZOiCkY0Y",  // Bot's display name
    ...
    DEV: process.env.DEV || "50943184305",                     // Developer's contact number
